...
from lab4_6.domain.pachet import to_str_pachet
...
from lab4_6.repo.rapoarte import numar_oferte
from lab4_6.repo.rapoarte import medie_pret
from lab4_6.repo.rapoarte import tiparire_pachete_perioada_pret
...
from lab4_6.repo.filtrari import sterge_luna
from lab4_6.repo.filtrari import eliminare_pret_dest
from lab4_6.utils.printing import print_lst_m
from lab4_6.utils.printing import print_lst_n
from lab4_6.utils.printing import print_lst_nou
...
def ui_eliminare_luna(l,lst_m):
    if len(l) == 0:
        ...
        user_input = int(input("Introduceti luna pachetelor pe care vreti sa le filtrati: "))
